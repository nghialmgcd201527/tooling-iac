...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/cognito-trigger")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/cognito-trigger")
  mock_outputs = {
...
dependencies {
  paths = ["../../../dev/iam-policy", "../../secret_manager", "../../../dev/codecommit/cognito-trigger", "../../../dev/codebuild/cognito-trigger"]
}
