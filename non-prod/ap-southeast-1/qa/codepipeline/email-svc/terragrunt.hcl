...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/email-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/email-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../dev/iam-policy", "../../secret_manager", "../../../dev/codecommit/email-svc", "../../../dev/codebuild/email-svc"]
}
