...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/web-identity")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/web-identity")
  mock_outputs = {
...
dependencies {
  paths = ["../../../dev/iam-policy", "../../secret_manager", "../../../dev/codecommit/web-identity", "../../../dev/codebuild/web-identity"]
}
