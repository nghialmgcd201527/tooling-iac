...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/core-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/core-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../dev/iam-policy", "../../secret_manager", "../../../dev/codecommit/core-svc", "../../../dev/codebuild/core-svc"]
}
