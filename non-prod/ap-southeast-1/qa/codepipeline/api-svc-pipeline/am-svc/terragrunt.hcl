...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/api-svc-build/am-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/api-svc-repo/am-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/api-svc-repo/am-svc", "../../../../dev/codebuild/api-svc-build/am-svc"]
}
