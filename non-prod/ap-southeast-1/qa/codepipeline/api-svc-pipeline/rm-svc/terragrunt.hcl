...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/api-svc-build/rm-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/api-svc-repo/rm-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/api-svc-repo/rm-svc", "../../../../dev/codebuild/api-svc-build/rm-svc"]
}
