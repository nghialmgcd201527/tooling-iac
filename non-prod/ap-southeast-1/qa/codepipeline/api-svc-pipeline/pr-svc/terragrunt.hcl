...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/api-svc-build/pr-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/api-svc-repo/pr-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/api-svc-repo/pr-svc", "../../../../dev/codebuild/api-svc-build/pr-svc"]
}
