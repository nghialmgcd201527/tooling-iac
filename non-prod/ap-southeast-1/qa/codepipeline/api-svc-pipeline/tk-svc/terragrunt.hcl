...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/api-svc-build/tk-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/api-svc-repo/tk-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/api-svc-repo/tk-svc", "../../../../dev/codebuild/api-svc-build/tk-svc"]
}
