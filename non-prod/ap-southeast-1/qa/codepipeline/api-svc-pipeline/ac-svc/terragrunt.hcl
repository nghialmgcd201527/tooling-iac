...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/api-svc-build/ac-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/api-svc-repo/ac-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/api-svc-repo/ac-svc", "../../../../dev/codebuild/api-svc-build/ac-svc"]
}
