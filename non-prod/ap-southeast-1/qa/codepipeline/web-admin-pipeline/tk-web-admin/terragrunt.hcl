...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/web-admin-build/tk-web-admin")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/web-admin-repo/tk-web-admin")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/web-admin-repo/tk-web-admin", "../../../../dev/codebuild/web-admin-build/tk-web-admin"]
}
