...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/web-admin-build/am-web-admin")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/web-admin-repo/am-web-admin")
  mock_outputs = {
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/web-admin-repo/am-web-admin", "../../../../dev/codebuild/web-admin-build/am-web-admin"]
}
