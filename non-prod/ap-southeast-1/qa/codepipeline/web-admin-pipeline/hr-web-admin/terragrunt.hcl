...
dependency "iam-policy" {
  config_path = find_in_parent_folders("dev/iam-policy")
  mock_outputs = {
...
dependency "codebuild" {
  config_path = find_in_parent_folders("dev/codebuild/web-admin-build/hr-web-admin")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("dev/codecommit/web-admin-repo/hr-web-admin")
  mock_outputs = {
    be_repo = "temporary-repo"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan", "init"]
}
...
dependencies {
  paths = ["../../../../dev/iam-policy", "../../../secret_manager", "../../../../dev/codecommit/web-admin-repo/hr-web-admin", "../../../../dev/codebuild/web-admin-build/hr-web-admin"]
}


# These are the variables we have to pass in to use the module specified in the terragrunt configuration above
inputs = {
  repo_name              = dependency.codecommit.outputs.codecommit_fe_repo
  ...
  codecommit_arn         = dependency.codecommit.outputs.codecommit_fe_arn
}
