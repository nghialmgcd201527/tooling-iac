...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/web-identity")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("codecommit/web-identity")
  mock_outputs = {
...
dependencies {
  paths = ["../../iam-policy", "../../secret_manager", "../../codecommit/web-identity", "../../codebuild/web-identity"]
}
