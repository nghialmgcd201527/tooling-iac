...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/web-admin-build/bd-web-admin")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("codecommit/web-admin-repo/bd-web-admin")
  mock_outputs = {
...
dependencies {
  paths = ["../../../iam-policy", "../../../secret_manager", "../../../codecommit/web-admin-repo/bd-web-admin", "../../../codebuild/web-admin-build/bd-web-admin"]
}
