...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/core-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("codecommit/core-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../iam-policy", "../../secret_manager", "../../codecommit/core-svc", "../../codebuild/core-svc"]
}
