...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/api-svc-build/hr-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("codecommit/api-svc-repo/hr-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../iam-policy", "../../../secret_manager", "../../../codecommit/api-svc-repo/hr-svc", "../../../codebuild/api-svc-build/hr-svc"]
}
