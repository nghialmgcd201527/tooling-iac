...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/api-svc-build/pm-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("codecommit/api-svc-repo/pm-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../iam-policy", "../../../secret_manager", "../../../codecommit/api-svc-repo/pm-svc", "../../../codebuild/api-svc-build/pm-svc"]
}
