...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/api-svc-build/cm-svc")
  mock_outputs = {
...
dependency "codecommit" {
  config_path = find_in_parent_folders("codecommit/api-svc-repo/cm-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../iam-policy", "../../../secret_manager", "../../../codecommit/api-svc-repo/cm-svc", "../../../codebuild/api-svc-build/cm-svc"]
}
