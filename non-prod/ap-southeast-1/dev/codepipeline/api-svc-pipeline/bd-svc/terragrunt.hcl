...
dependency "codebuild" {
  config_path = find_in_parent_folders("codebuild/api-svc-build/bd-svc")
  mock_outputs = {
...
dependencies {
  paths = ["../../../iam-policy", "../../../secret_manager", "../../../codecommit/api-svc-repo/bd-svc", "../../../codebuild/api-svc-build/bd-svc"]
}
