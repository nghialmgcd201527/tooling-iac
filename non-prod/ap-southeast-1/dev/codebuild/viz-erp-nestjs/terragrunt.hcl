locals {
  ...
  service_repo = local.environment_vars.locals.viz_erp_nestjs_repo
  build_branch = local.environment_vars.locals.build_branch
  project_name = local.environment_vars.locals.project_name
}
dependencies {
  paths = ["../../vpc", "../../iam-policy", "../../secret_manager", "../../codecommit/viz-erp-nestjs"]
}

dependency "ts-common" {
  config_path = find_in_parent_folders("codecommit/viz-erp-nestjs")
  mock_outputs = {
